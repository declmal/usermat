...
c
c       subroutine fdjac_ext(fcn,n,x,fvec,fjac,ldfjac,iflag,ml,mu,epsfcn,
c                         wa1,wa2,ext,lext)
c
c     where
c
...
c         the user wants to terminate execution of fdjac_ext.
...
c         the execution of fdjac_ext. see description of fcn.
c
...
c
  ...
  110 continue
      return
c
c     last card of subroutine fdjac_ext.
c
      end
