...
lsdyna: init_dyn21 dyn21 umat41 dyn21b umat41c couple2other_user dynrfn_user minpack
	ifort -o lsdyna init_once.o init_dyn21.o dynm.o dyn21.o umat41.o dyn21b.o umat41c.o murcia.o couple2other_user.o dynrfn_user.o adummy_graph.o orderByMetis.o    adummy_msc.o mscapi.o libminpack.a libdyna.a libbcsext4.a liblsda.a liblssecurity.a  liblcpack.a libspooles.a libcparse.a libmf2.a liblsm.a liblscrypt.a libresurf.a libsfg.a libmetis.a libim_rotor_dynamics.a libarpack.a  libfemster_wrap.a libfemster_wrap2d.a libfemster_wrap1d.a libfemster.a libfemster2d.a libfemster1d.a libpfem.a libmetis.a libblas.a liblapack.a libfftw3.a  intel64_131_libansysdp.a  libdyna.a libblas.a liblapack.a libmetis.a  -i-static -L/usr/X11R6/lib64 -lX11 -openmp  -lstdc++ -lrt -lstdc++ 
#
...
umat41c: umat41c.f nhisparm.inc murcia.f
	...
	ifort -c -safe_cray_ptr -assume byterecl,buffered_io,protect_parens -warn nousage -zero -ftz -fp-model precise -mP2OPT_hpo_dist_factor=21 -diag-disable 10212,10010 -xSSE3 -align array16byte -nopad -openmp -i8 -r8  -DINTEL -DAdd_ -O2 -I. murcia.f
