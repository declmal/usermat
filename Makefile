...
lsdyna: init_dyn21.o dyn21.o umat41 dyn21b.o umat41c couple2other_user.o dynrfn_user.o hybrdext.o hybrd1ext.o fdjac1ext.o minpack.o
...
hybrd1ext.o: hybrd1ext.f
	ifort -c -safe_cray_ptr -assume byterecl,buffered_io,protect_parens -warn nousage -zero -ftz -fp-model precise -mP2OPT_hpo_dist_factor=21 -diag-disable 10212,10010 -xSSE3 -align array16byte -nopad -openmp -i8 -r8  -DINTEL -DAdd_ -O2 -I. hybrd1ext.f
fdjac1ext.o: fdjac1ext.f
